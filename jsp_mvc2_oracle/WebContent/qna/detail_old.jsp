...
<form name="iform">
	<table border="1">
		...
		<tr>
			<td>작성자</td><td><input type="text" value="<%=qwriter %>" name="i_writer" readonly="readonly" id="writer"></td>
		</tr>
		<tr>
			<td>조회수</td><td><%=qreadcount %></td>
		</tr>
		<tr>
			<td>작성일</td><td><%=qdate %></td>
		</tr>
		<tr>
			<td>제목</td><td><input type="text" value="<%=qtitle %>" name="i_title" readonly="readonly" id="title"></td>
		</tr>
		<tr>
			<td>내용</td><td><textarea cols="25" rows="10" name="i_content" readonly="readonly" id="content"><%=qcontent %></textarea></td>
		</tr>
		<tr>
			<td>파일</td><td><%=filename %></td>
		</tr>
		<tr>
			<td>썸네일</td><td><%=thumbnail %></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
			<a href="./list.do">Go List</a>&nbsp;
			<a href="#" id="goEdit">Go Edit</a>&nbsp;
			<a href="./remove.do?cnum=<%=qnum %>">Remove</a>&nbsp;
			</td>
		</tr>
	</table>
</form>
